          ...
          <div className="grid grid-cols-1 sm:grid-cols-4 gap-4">
            {images.map((img) => (
              <div key={img.id} className="relative group">
                ...
                {img.extractedText && (
                  <div className="absolute bottom-10 left-0 right-0 bg-black bg-opacity-70 text-white text-xs p-2 max-h-20 overflow-y-auto">
                    <p className="break-words">{img.extractedText}</p>
                  </div>
                )}
                
                {/* Error Message */}
                {img.error && (
                  <div className="absolute bottom-10 left-0 right-0 bg-red-600 bg-opacity-80 text-white text-xs p-2">
                    {img.error}
                  </div>
                )}
